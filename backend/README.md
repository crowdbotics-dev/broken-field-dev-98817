...
## Project Structure
    ...
    ├── broken_field_dev_98817  # Django project configurations
...
1. Clone this repo and `cd broken_field_dev_98817`
...
2. Clone this repo and `cd broken_field_dev_98817`
