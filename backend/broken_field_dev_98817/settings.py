"""
Django settings for broken_field_dev_98817 project.
...
ROOT_URLCONF = 'broken_field_dev_98817.urls'
...
WSGI_APPLICATION = 'broken_field_dev_98817.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_field_dev_98817 API",
    "DESCRIPTION": "API documentation for broken_field_dev_98817 App",
    "VERSION": "v1",
}
